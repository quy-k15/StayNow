...
const DetailRoomCard = ({ name, onExit }) => {
  return (
    <div className="w-full bg-[#E8D4B9] absolute z-10 top-35 rounded-sm">
        <div className="w-full relative">
             <h2 className="text-3xl p-4 font-lodestone">{name}</h2>
             <BiExitFullscreen  className="absolute top-0 right-0 m-3 text-3xl cursor-pointer" onClick={onExit}/>
        </div>
      ...
      <div className="flex">
        ...
        <div className="lg: w-1/3 flex flex-col justify-between">
          <div className="px-5">
            ...
            <hr className="h-0.5 w-full bg-[#F2B03F] border-none my-3"></hr>
